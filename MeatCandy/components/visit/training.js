...
class VisitTraining extends Component {
  ...
  showMaterials() {
    Linking.canOpenURL(this.state.training.materials).then(supported => {
      if(supported) {
          return Linking.openURL(this.state.training.materials);
      }else{
      ...
      return (
        ...
        >
          ...
          <Text style={styles.modalTitle}>{title}</Text>
            ...
            <Button title="Materiały" onPress={() => this.showMaterials()} style={{margin: 5}}/>
            <TextInput
